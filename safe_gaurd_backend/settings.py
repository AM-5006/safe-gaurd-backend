"""
Django settings for safe_gaurd_backend project.
...
ROOT_URLCONF = 'safe_gaurd_backend.urls'
...
WSGI_APPLICATION = 'safe_gaurd_backend.wsgi.application'
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=5*365),
...
SWAGGER_SETTINGS = {
    ...
    'USE_SESSION_AUTH': False,  # Use Token instead of session for authentication
    'LOGOUT_URL':"/swagger/",
    'USE_COOKIES': True,
    'PERSIST_AUTH': True,
}
